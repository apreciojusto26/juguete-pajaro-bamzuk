      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
        {variants.map((variant) => {
          ...
          return (
            ...
            >
              {isPopular && (
                <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-pill bg-gold-deep px-2 py-0.5 text-[0.5625rem] font-black uppercase tracking-wider text-white shadow-card sm:text-[0.625rem]">
                  Más elegido
                </span>
              )}
              <input
