          ...
          >
            <h3>
              <button
                ...
                className="flex min-h-12 w-full items-start justify-between gap-4 px-4 py-3.5 text-left text-sm font-bold leading-snug text-graphite md:px-5 md:py-4 md:text-base"
              >
