    ...
    <div className="fixed inset-0 z-[70] flex items-start justify-center overflow-y-auto bg-graphite/70 px-3 pb-6 pt-24 backdrop-blur-sm sm:items-center sm:pt-3">
      ...
      >
        ...
        */}
        ...
        >
          {/*
            Vivid red, not the brand green: this sits over whatever the page
            happens to show, blurred and dark, where #1A531A would wash out.
            The drop-shadow is what actually guarantees contrast,
